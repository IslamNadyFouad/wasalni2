...
//console.log(id);
    ...
    cross.addEventListener('click', (e) => {
        ...
        //db.collection('cafes').doc(id).delete();
         firebase.database().ref().child("Admin").child(id).remove();
...
form.addEventListener('submit', (e) => {
    ...
    var newSeatKey = firebase.database().ref().child('Admin').push();
    newSeatKey.set({
...
document.getElementById("updateBtn").addEventListener("click", function(){
   ...
   var newSeatKey = firebase.database().ref().child('Admin/'+ThebusId);
    newSeatKey.update({
